...
```
Set database name (DB_DATABASE=inactive_user_reminder)
...
10.**To run the scheduled inactive-reminder command daily:**
```bash
...
12.**Configure SMS API credentials in SmsService.php if using SMS feature**
